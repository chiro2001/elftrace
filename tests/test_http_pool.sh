...
run_trace "$TF_TMP/http_pool_r1" || { echo "FAIL: Run1"; tail -3 "$TF_TMP/http_pool_trace.log"; exit 1; }
...
run_trace "$TF_TMP/http_pool_r2" "$COMP" || { echo "FAIL: Run2"; tail -3 "$TF_TMP/http_pool_trace.log"; exit 1; }
